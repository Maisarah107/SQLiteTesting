package id.ac.poliban.mi.cahyo.sqlitetesting;
...
import id.ac.poliban.mi.cahyo.sqlitetesting.dao.impl.FriendDaoImplSQLite;
...
public class MainActivity extends AppCompatActivity {
    private List<Friend> data = new ArrayList<>();
    {
        ...
        data.add(new Friend("Yusie Rizal", "HKSN, Banjaramasin", "0812228"));
