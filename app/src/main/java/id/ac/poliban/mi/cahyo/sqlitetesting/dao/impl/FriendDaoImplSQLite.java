package id.ac.poliban.mi.cahyo.sqlitetesting.dao.impl;
...
import id.ac.poliban.mi.cahyo.sqlitetesting.dao.FriendDao;
...
public class FriendDaoImplSQLite extends SQLiteOpenHelper implements FriendDao {
    private static final String DB_NAME = "poliban.db";
